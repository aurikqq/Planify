...
@Composable
fun PlansScreen(navController: NavController, modifier: Modifier = Modifier) {
                                ...
                                modifier = Modifier
                                    ...
                                    .combinedClickable(
                                        ...
                                        onLongClick = {
                                            ...
                                            Toast.makeText(
                                                context,
                                                if (isDebugEnabled) "Debug enabled. No functionality so far" else "Debug disabled",
                                                Toast.LENGTH_SHORT
                                            ).show()
                                        })
                            )
            ...
            item {
                ...
                if (!havePlans) {
                    Button(
                        onClick = {
                            historyDate =
                                SimpleDateFormat("d MMMM yyyy, EEEE", Locale.getDefault()).format(
                                    Date()
                                )
                            ...
                            Toast.makeText(
                                context,
                                context.getString(R.string.toast_added_plans), Toast.LENGTH_SHORT
                            ).show()
                        },
...
fun PlansPreview() {
    PlanifyTheme {
        PlansScreen(navController = NavController(LocalContext.current))
    }
}
