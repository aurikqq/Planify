...
const val CHANGELOG = "• Первое обновление интерфейса приложения (да, оно будет не одно)\n" +
        ...
        "• Добавлена возможность отправить логи для того, чтобы я мог понять источник ошибки - даже если Planify не запускается.\n\n" +
        "• ❄\uFE0F\uD83E\uDD5A\n\n"
